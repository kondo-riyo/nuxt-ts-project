<template>
  <div class="md:flex h-screen w-full">
    <Header class="flex-grow-0 w-2/12 h-full text-gray-800" />
    <Nuxt class="flex-grow w-11/12 h-full bg-gray-50 text-gray-800" />
    <Footer class="flex-grow-0 w-1/12 h-full text-gray-800" />
  </div>
</template>
